  ...
  const packages = [
    {
      name: 'Basic',
      price: '₱1,200',
      subtitle: 'Perfect for simple birthday celebrations',
      highlight: false,
      features: [
        '25 invitations',
        'Standard paper',
    ...
    },
    {
      name: 'Premium',
      price: '₱4,000',
      subtitle: 'For bigger and more stylish events',
      highlight: false,
      features: [
        '80 invitations',
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-6 mb-12 text-center">
          ...
          <h1 className="mt-3 text-3xl font-bold text-gray-900 md:text-5xl">
            Fun and Creative Birthday Packages
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-gray-600">
            Choose a birthday package that fits your celebration style, guest count,
            and budget.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4">
            <div className="border-b border-gray-200 bg-gradient-to-b from-orange-50 to-white p-8 lg:border-b-0 lg:border-r">
              ...
              <p className="mt-4 text-sm leading-7 text-gray-600">
                Compare our birthday package options and pick the one that works
                best for your event. All packages include quality printing and
                layout preparation.
              </p>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600">
            Need a customized birthday package? We can adjust the quantity,
            materials, and inclusions based on your needs.
          </p>
