  ...
  const packages = [
    {
      name: 'Basic',
      price: '₱1,300',
      subtitle: 'For simple and meaningful celebrations',
      highlight: false,
      features: [
        '25 invitations',
        'Standard paper',
    ...
    },
    {
      name: 'Premium',
      price: '₱4,200',
      subtitle: 'For elegant and memorable events',
      highlight: false,
      features: [
        '80 invitations',
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-6 mb-12 text-center">
          ...
          <h1 className="mt-3 text-3xl font-bold text-gray-900 md:text-5xl">
            Elegant Packages for Baptismal Celebrations
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-gray-600">
            Thoughtfully designed baptismal packages prepared for meaningful and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4">
            <div className="border-b border-gray-200 bg-gradient-to-b from-orange-50 to-white p-8 lg:border-b-0 lg:border-r">
              ...
              <p className="mt-4 text-sm leading-7 text-gray-600">
                Compare our baptismal package options and find the best one for
                your special occasion. Every package includes quality printing
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600">
            Need a customized baptismal package? We can adjust the quantity,
            materials, and inclusions based on your preference.
          </p>
