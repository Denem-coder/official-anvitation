...
const weddingInsertDesignsData = [
  {
    ...
    pages: {
      ...
      inside: orangeInsert1Inside,
      third: orangeInsert1Third,
      back: orangeInsert1Last,
    },
...

  {
    ...
    pages: {
      ...
      inside: orangeInsert2Inside,
      third: orangeInsert2Third,
      back: orangeInsert2Last,
    },
...

  {
    ...
    pages: {
      ...
      inside: orangeInsert3Inside,
      third: orangeInsert3Third,
      back: orangeInsert3Last,
    },
...

  {
    ...
    pages: {
      front: greenInsert1Front,
      inside: greenInsert1Inside,
      third: greenInsert1Third,
      back: greenInsert1Last,
    },

    // used in grid preview
    cover: greenInsert1Front,
...

  {
    ...
    pages: {
      front: greenInsert2Front,
      inside: greenInsert2Inside,
      third: greenInsert2Third,
      back: greenInsert2Last,
    },

    // used in grid preview
    cover: greenInsert2Front,
...

  {
    ...
    pages: {
      front: greenInsert3Front,
      inside: greenInsert3Inside,
      third: null,
      back: greenInsert3Last,
    },

    // used in grid preview
    cover: greenInsert3Front,
...

  {
    ...
    pages: {
      front: redInsert1Front,
      inside: redInsert1Inside,
      third: redInsert1Third,
      back: redInsert1Last,
    },

    // used in grid preview
    cover: redInsert1Front,
...

  {
    ...
    pages: {
      front: blueInsert1Front,
      inside: blueInsert1Inside,
      third: blueInsert1Third,
      back: blueInsert1Last,
    },

    // used in grid preview
    cover: blueInsert1Front,
...

  {
    ...
    pages: {
      front: blackInsert1Front,
      inside: blackInsert1Inside,
      third: null,
      back: blackInsert1Last,
    },

    // used in grid preview
    cover: blackInsert1Front,
...

  {
    ...
    pages: {
      front: blackInsert2Front,
      inside: blackInsert2Inside,
      third: blackInsert2Third,
      back: blackInsert2Last,
    },
